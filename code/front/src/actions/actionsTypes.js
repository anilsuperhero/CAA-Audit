...
export const LOAD_REQUEST_AUDIT_DATA_SUCCESS =
  "LOAD_REQUEST_AUDIT_DATA_SUCCESS";
export const LOADED_AUDITOR_DATA_SUCCESS = "LOADED_AUDITOR_DATA_SUCCESS";
export const PRE_LOADER_REQUEST_STATUS = "PRE_LOADER_REQUEST_STATUS";
export const OTHER_DOCUMENTS = "OTHER_DOCUMENTS";
export const LOADED_CHAT_INFO_SUCCESS = "LOADED_CHAT_INFO_SUCCESS";
export const LOADED_DASHBOARD_SUCCESS = "LOADED_DASHBOARD_SUCCESS";
export const LOAD_VIEW_TYPE_STATUS = "LOAD_VIEW_TYPE_STATUS";
