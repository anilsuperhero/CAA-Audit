...
const FormDialog = (props) => {
  ...
  const { open, setOpen, itemDocument, registrationId, applicable } = props;
  ...
  const onSubmit = () => {
    if (applicable) {
      ...
      dispatch(singleDocument(request, closeModel, "SINGLE"));
    } else {
      ...
      dispatch(singleDocument(formData, closeModel, "SINGLE"));
    }
  };
