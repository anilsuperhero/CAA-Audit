...
export default function CustomizedDialogs(props) {
  ...
  const [showDate, setShowDate] = useState(keyItem.dob);
  const onSubmit = (data) => {
    if (date === null) {
      dispatch(
        loadToasterData({
  ...
  const handleClickDate = (date) => {
    if (date) {
      setValue("dob", date.format("DD-MM-YYYY"));
  ...
  useEffect(() => {
    if (item.dob) {
      setValue("dob", moment(new Date(item.dob)).format("DD-MM-YYYY"));
      setShowDate(moment(item.dob).format("DD-MM-YYYY"));
      setDate(item.dob);
    }
  }, [item, setValue]);
                    ...
                    <TextField
                      ...
                      inputRef={register({
                        ...
                        minLength: {
                          value: 1,
                          message:
                            "First name should contain at least 1 characters.",
                        },
                        maxLength: {
                          value: 50,
                          message:
                    ...
                    <TextField
                      ...
                      inputRef={register({
                        minLength: {
                          value: 1,
                          message:
                            "Last name should contain at least 1 characters.",
                        },
                        maxLength: {
                          value: 50,
                    ...
                    <TextField
                      ...
                      inputRef={register({
                        ...
                        minLength: {
                          value: 1,
                          message:
                            "Position Held should contain at least 1 characters.",
                        },
                        maxLength: {
                          value: 500,
                          message:
