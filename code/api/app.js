...
var documentTypeRouter = require("./routes/documentType");
...
var CompanyDocumentRouter = require("./routes/companyDocument");
...
app.use("/v1/dcoumentType", documentTypeRouter);
...
app.use("/v1/companyDocument", CompanyDocumentRouter);
...
app.use(
  "/company_document",
  express.static(path.join(__dirname, "public/company_document/"))
);
app.use("/invoice", express.static(path.join(__dirname, "public/invoices/")));
app.use(
  "/personnels",
  express.static(path.join(__dirname, "public/personnels/"))
);
